...
test('Testa se card é renderizado com as informações de um pokemon', () => {
...
test('testa se quando clicar em More Details redireciona para (URL/pokemons/id)', () => {
...
test('verifuca estrela no pokemon favorito', () => {
